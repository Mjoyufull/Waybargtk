...
class Workspaces : public AModule, public EventHandler {
 public:
  ...
  // Enhanced workspace feature getters
  auto deduplicateWindows() const -> bool { return m_deduplicateWindows; }
  auto workspaceGrouping() const -> std::string { return m_workspaceGrouping; }
  auto useSystemIcons() const -> bool { return m_useSystemIcons; }
  auto iconSize() const -> int { return m_iconSize; }
  auto specialWorkspaceIndicator() const -> std::string { return m_specialWorkspaceIndicator; }
  auto specialWorkspaceIconScale() const -> double { return m_specialWorkspaceIconScale; }
  auto showWorkspaceNumber() const -> bool { return m_showWorkspaceNumber; }
  auto showSpecialWorkspaceNumber() const -> bool { return m_showSpecialWorkspaceNumber; }
 ...
 private:
  ...
  std::string m_workspaceGrouping = "default";  // "default", "paired"
  bool m_useSystemIcons = false;
  int m_iconSize = 16;
  std::string m_specialWorkspaceIndicator = "󰍠";
  double m_specialWorkspaceIconScale = 0.75;
  bool m_showWorkspaceNumber = false;           // Show superscript workspace number for regular workspaces
  bool m_showSpecialWorkspaceNumber = false;    // Show superscript workspace number for special workspaces
